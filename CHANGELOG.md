...
- **deps-dev:** bump the dev-dependencies group across 1 directory with 4 updates
...
- resolve dropped/opened file paths via bridge, not removed File.path

### Tests

- make handleFile path-resolution test deterministic

## v0.0.178 — 2026-08-15

### Features

- infer "Generated by" tool in File info from document content
- add File info panel showing on-disk path and metadata
...
- fullscreen diagram minimap rendered an empty box
